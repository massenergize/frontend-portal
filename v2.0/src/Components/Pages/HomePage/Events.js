				...
				<div className="container">
					<div className="row">
						...
						<div className="col-md-3 col-sm-2 col-xs-12 text-center text-sm-right">
							<Link to={`${this.props.links.events}`} className="all-events-button cool-font thm-btn mb-4">All Events</Link>
						</div>
					</div>
					<div className="row">
						<article className=" cool-font col-md-6 col-sm-12 col-xs-12">
