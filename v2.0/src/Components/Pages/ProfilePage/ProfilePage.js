										...
										<div className="container" style={{ padding: 0 }}>
											<div className="counter-outer" style={{ background: "white", width: "100%" }}>
												<div className="row no-gutter">
													...
													<div className="column counter-column col-lg-4 col-6"  >
														<Counter end={(this.props.done || []).map(t => t.action && t.action.calculator_action ?  t.action.calculator_action.average_points : 0).reduce((partial_sum, a) => partial_sum + a,0)} unit={"lbs CO2-eq"} icon={"fa fa-leaf"} title={"Impact"} />
													</div>
												</div>
											</div>
										</div>
