								...
								<div className='col-12' style={{ margin: 40 }}>
									...
									<ul className="normal">
										{vendor.services.map((service) => {
											return <li style={{ display: 'inline-block', marginLeft:0,marginRight:'2em'}} key={vendor.name + "-" + service.id}><b>{service.name}</b>&nbsp;&nbsp;&nbsp;<p>{service.description}</p></li>;
										})}
									</ul>
								</div>
								: null
			...
			return (
				<div>
					<div className='text-center'>
						<h4 style={{ background: 'rgb(249, 251, 249)', color: '#383838', padding: 26 }}> Testimonials about this Service Provider </h4>
					</div>
