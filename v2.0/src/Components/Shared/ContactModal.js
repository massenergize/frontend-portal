      ...
      <div>
        <div className="modal-box z-depth-2">
          ...
          <center>
            ...
            <div>
              <input id="contact-title" type="text" name ="subject" className="form-control" onChange = {(event)=>this.props.handleTextFxn(event)} style={{padding:15,marginBottom:7}} placeholder ="Subject..." />
