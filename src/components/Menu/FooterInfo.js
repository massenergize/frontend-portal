				...
				<div className="footer-widget about-column">
					...
					<ul className="contact-info">
						...
						{this.props.info.email &&
							<li><span className="icon-e-mail-envelope"></span><Link className="energize-link" to={`/${community.subdomain}/contactus`}>Click to contact Community Organizer </Link> </li>
						}
