...
export const SET_IS_SANDBOX = 'SET_IS_SANDBOX'
export const SET_IS_CUSTOM_SITE = 'SET_IS_CUSTOM_SITE'
export const LOAD_COMMUNITY_INFORMATION = "LOAD_COMMUNITY_INFORMATION"
/****
 * Links 
 */
...
export const LOAD_EQUIVALENCES = "LOAD_EQUIVALENCES";
export const SET_PREFERRED_EQUIVALENCE = "SET_PREFERRED_EQUIVALENCE";
export const TOGGLE_GUEST_MODE_DIALOG = "TOGGLE_GUEST_MODE_DIALOG";
export const  USER_IS_GUEST = "USER_IS_GUEST";
export const TOGGLE_UNIVERSAL_MODAL = "TOGGLE_UNIVERSAL_MODAL"; 

export const LOAD_SETTINGS = "LOAD_USER_SETTINGS";

export const TOGGLE_UNIVERSAL_TOAST = "TOGGLE_UNIVERSAL_TOAST";
export const SAVE_COMMUNITY_FEATURE_FLAGS_TO_REDUX = "SAVE_COMMUNITY_FEATURE_FLAGS_TO_REDUX";
export const MARK_REQUEST_AS_DONE  = "MARK_REQUEST_AS_DONE";
